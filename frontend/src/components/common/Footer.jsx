      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-text-secondary mb-4">
              Your trusted platform for finding pharmacies and managing healthcare needs.
              Connect with local pharmacies and access quality healthcare services.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-text-muted hover:text-theme-primary transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-text-secondary hover:text-theme-primary transition-colors duration-200">
                  Find Pharmacies
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-border-primary mt-8 pt-8 text-center">
          <p className="text-text-muted">
            © 2025 MediFind. All rights reserved. | Made with ❤️ for better healthcare access.
          </p>
        </div>
      </div>
    </footer>
